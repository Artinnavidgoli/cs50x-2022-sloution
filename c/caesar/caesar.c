...
int main(int argc, string argv[])
{
    ...
    for (int key = 0; key < strlen(argv[1]); key++)
    {
        ...
        {
            printf("where is my key ?(Usage: ./caesar key)\n");
            return 1;
        }
    }
    ...
    printf("\n");
    return 0; // if you think this comment is for style50 you are a very professionsl programmer
